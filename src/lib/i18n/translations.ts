...
export const en = {
  ...
  auth: {
    ...
    agreeToTermsLinkTerms: "Terms of Service",
    agreeToTermsMiddle: "and",
    agreeToTermsLinkPrivacy: "Privacy Policy",
  ...
  dashboard: {
    ...
    todayQuestion: "What do you want to do today?",
    startNewPractice: "Practice a talk",
    startExamPrep: "Prepare an exam",
...
export const es: Dictionary = {
  ...
  auth: {
    ...
    agreeToTermsLinkTerms: "Términos de Servicio",
    agreeToTermsMiddle: "y la",
    agreeToTermsLinkPrivacy: "Política de Privacidad",
    mustAgreeToTerms: "Debes aceptar los Términos y la Política de Privacidad para continuar.",
  ...
  dashboard: {
    ...
    todayQuestion: "¿Qué quieres hacer hoy?",
    startNewPractice: "Practicar un oral",
    startExamPrep: "Preparar un examen",
...
export const fr: Dictionary = {
  ...
  auth: {
    ...
    agreeToTermsLinkTerms: "Conditions Générales",
    agreeToTermsMiddle: "et la",
    agreeToTermsLinkPrivacy: "Politique de Confidentialité",
    mustAgreeToTerms: "Tu dois accepter les Conditions et la Politique de Confidentialité pour continuer.",
  ...
  dashboard: {
    ...
    todayQuestion: "Que veux-tu faire aujourd'hui ?",
    startNewPractice: "Pratiquer un oral",
    startExamPrep: "Préparer un examen",
    improvementPrefix: "points",
    improvementSuffix:
  ...
  modes: {
    ...
    "oral-exam": "Examen oral",
    "project-defense": "Personnalisé",
    "brevet-oral": "Oral du Brevet",
    "bac-francais-oral": "Oral du Bac de Français",
    "grand-oral": "Grand Oral",
  },
  modeDescriptions: {
    presentation: "Prépare un exposé ou une présentation",
    "startup-pitch": "Entraîne-toi à présenter une idée ou un projet",
    interview: "Décrocher le poste",
    "oral-exam": "Défendre tes connaissances",
    "project-defense": "Crée ton propre entraînement",
