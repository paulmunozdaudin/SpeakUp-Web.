...
export const en = {
  ...
  practice: {
    title: "New practice",
    subtitle: "Set the stage, hit record, and speak like the room is full.",
    topicLabel: "What are you presenting?",
    topicPlaceholder: "e.g. Q3 results, thesis defense, seed pitch…",
    modeLabel: "Practice mode",
    untitled: "Untitled practice",
    pressMic: "Press the mic to start",
    recording: "Recording",
    paused: "Paused",
  ...
  results: {
    ...
    reportsSoon: "PDF reports are coming soon!",
    ...
    noFillers: "No filler words detected — impressive!",
    fillersDetectedSingular: "filler word detected in this session:",
    fillersDetectedPlural: "filler words detected in this session:",
...
export const es: Dictionary = {
  ...
  landing: {
    ...
    testimonials: [
      {
        quote:
          "Ensayé mi pitch de ronda semilla 14 veces con SpeakUp. El día del demo day no estaba nervioso: estaba listo.",
        name: "Sofía M.",
    ...
    plans: [
      {
        ...
        price: "0 €",
        period: "para siempre",
        description: "Perfecto para probar SpeakUp.",
        features: [
  ...
  practice: {
    ...
    subtitle:
      "Prepara el escenario, pulsa grabar y habla como si la sala estuviera llena.",
    topicLabel: "¿Qué vas a presentar?",
    topicPlaceholder: "p. ej. Resultados Q3, defensa de tesis, pitch semilla…",
    modeLabel: "Modo de práctica",
    untitled: "Práctica sin título",
    pressMic: "Pulsa el micro para empezar",
    recording: "Grabando",
    paused: "En pausa",
    ...
    resume: "Reanudar",
    stop: "Detener",
    analyzeRecording: "Analizar grabación",
    retake: "Repetir",
    or: "o",
    uploadFile: "Subir un archivo de audio",
    micDenied:
    ...
    analyzingSteps: [
      "Subiendo tu grabación…",
      "Transcribiendo tu discurso…",
      "Evaluando claridad y ritmo…",
      "Redactando tu feedback personalizado…",
    ],
  },
  results: {
    overall: "Global",
    ...
    reportsSoon: "¡Los informes en PDF llegan pronto!",
    detailedBreakdown: "Desglose detallado",
    clarity: "Claridad",
    confidence: "Confianza",
    pace: "Ritmo al hablar",
    wordsPerMin: "palabras/min",
    structure: "Estructura",
    persuasiveness: "Persuasión",
    vocabulary: "Vocabulario",
    fillerWords: "Muletillas",
    noFillers: "No se detectaron muletillas — ¡impresionante!",
    fillersDetectedSingular: "muletilla detectada en esta sesión:",
    fillersDetectedPlural: "muletillas detectadas en esta sesión:",
    coachInsights: "Observaciones del coach",
    strengths: "Fortalezas",
    areasToImprove: "Puntos a mejorar",
    personalizedTips: "Consejos personalizados",
    nextExercises: "Próximos ejercicios",
  ...
  modes: {
    ...
    school: "Presentación escolar",
    "ted-talk": "Charla TED",
    "sales-pitch": "Pitch de ventas",
    "language-exam": "Examen de idioma",
  },
  scoreLabels: {
    excellent: "Excelente",
    great: "Muy bien",
