    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Cámara (solo si eliges el modo «Voz + cámara»): nunca se activa por defecto y nunca se sube ni se guarda el vídeo. Se extraen unos pocos fotogramas fijos en tu propio navegador para analizar tu mirada, postura, gestos y presencia, y esos fotogramas se descartan en cuanto termina el análisis — no forman parte de tu historial ni se almacenan en ningún sitio.",
          ...
          "Datos de facturación (solo si contratas el plan Pro): tu email y el estado de la suscripción. Los datos de pago en sí (número de tarjeta, etc.) los recoge y almacena Lemon Squeezy directamente, no nosotros.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Lemon Squeezy: si contratas el plan Pro, procesa el pago. Lemon Squeezy recibe tu email y los datos de tu tarjeta directamente — nosotros nunca vemos ni almacenamos el número completo de tu tarjeta. De Lemon Squeezy solo recibimos un identificador de cliente y el estado de tu suscripción (activa, cancelada, etc.).",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Caméra (seulement si tu choisis le mode « Voix + caméra ») : elle n'est jamais activée par défaut et la vidéo n'est jamais envoyée ni conservée. Quelques images fixes sont extraites directement dans ton navigateur pour analyser ton regard, ta posture, tes gestes et ta présence, puis supprimées dès que l'analyse est terminée — elles ne font partie d'aucun historique et ne sont stockées nulle part.",
          ...
          "Données de facturation (seulement si tu souscris au plan Pro) : ton email et le statut de ton abonnement. Les données de paiement elles-mêmes (numéro de carte, etc.) sont collectées et stockées directement par Lemon Squeezy, pas par nous.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Lemon Squeezy : si tu souscris au plan Pro, il traite ton paiement. Lemon Squeezy reçoit directement ton email et les détails de ta carte — nous ne voyons ni ne stockons jamais ton numéro de carte complet. De Lemon Squeezy, nous ne recevons qu'un identifiant client et le statut de ton abonnement (actif, annulé, etc.).",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Camera (only if you choose \"Voice + camera\"): it's never turned on by default, and the video itself is never uploaded or kept. A handful of still frames are extracted right in your browser to analyze your eye contact, posture, gestures and presence, then discarded as soon as the analysis finishes — they're never part of your history or stored anywhere.",
          ...
          "Billing data (only if you subscribe to Pro): your email and subscription status. Payment data itself (card number, etc.) is collected and stored directly by Lemon Squeezy, not by us.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Lemon Squeezy: if you subscribe to the Pro plan, it processes your payment. Lemon Squeezy receives your email and card details directly — we never see or store your full card number. From Lemon Squeezy we only receive a customer identifier and your subscription status (active, cancelled, etc.).",
